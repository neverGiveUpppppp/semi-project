...
<div class="cardContainer">
  ...
  <div class="cardBox" id="cardBoxDetail">
    ...
    <div class="cardBoxText">
      <div class="card-body">
        <strong class="mb-lg-1 reviewCategory"><%= list.get(0).getFoodType() %><!-- 중식 --></strong><br>
        <h5 class="card-title cardTitle"><%= list.get(0).getRestaurantName() %><!-- 식당명 --></h5>
    ...
    <div class="cardBox" id="cardBoxDetail">
      ...
      <div class="cardTxt">
        <div class="card-body">
          <strong class="mb-lg-1 reviewCategory"><%= list.get(1).getFoodType() %><!-- 중식 --></strong><br>
          <h5 class="card-title cardTitle"><%= list.get(1).getRestaurantName() %><!-- 식당명 --></h5>
    ...
    <div class="cardBoxText">
      <div class="card-body">
        <strong class="mb-lg-1 reviewCategory"><%= list.get(2).getFoodType() %><!-- 중식 --></strong><br>
        <h5 class="card-title cardTitle"><%= list.get(2).getRestaurantName() %><!-- 식당명 --></h5>
    ...
    <div class="cardBox" id="cardBoxDetail">
      ...
      <div class="">
        <div class="card-body">
        <strong class="mb-lg-1 reviewCategory"><%= list.get(3).getFoodType() %><!-- 중식 --></strong><br>
        <h5 class="card-title cardTitle"><%= list.get(3).getRestaurantName() %><!-- 식당명 --></h5>
